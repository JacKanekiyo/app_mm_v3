          ...
          Container(
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage("assets/chat_background.jpg"), // Substitua pelo caminho da sua imagem
                fit: BoxFit.cover,
              ),
            ),
          ),
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Align(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: isUserMessage ? Color.fromARGB(255, 194, 230, 195) :Color.fromARGB(255, 12, 137, 104),
                    ...
                    Expanded(
                      child: TextFormField(
                        ...
                        onFieldSubmitted: (value) async {
                          addMessage(value, true); // Adiciona a mensagem do usuário ao histórico
                          setState(() {
                            loading = true;
                          });
